...
Only _limit_ order types support `post_only`.
...
You must also have at least _one_ of the following:
...
:::info
For more details on rate limiting, see the official documentation: [https://binance-docs.github.io/apidocs/futures/en/#limits](https://binance-docs.github.io/apidocs/futures/en/#limits).
:::
